...
public class superbbb {
	...
	public static void main(String[] args) {
		...
		String carrinhoProduto [] = new String [10];
		...
		do {
			...
			do {
				...
				carrinhoProduto[indice] = produto;
		...
		//Mostrar os produtos VARIA- carrinhoQuantidade, valor1
		
		for (int i = 0; i < carrinhoQuantidade.length; i++) {
			
			if (carrinhoQuantidade[i] > 0 ) {
				indice = 0;
				
				
			System.out.println("Produto: "+ carrinhoProduto[indice] + "\t" + carrinhoQuantidade[i] + " Unidade\t" + valorAgregado[i] + " Reais"  );
